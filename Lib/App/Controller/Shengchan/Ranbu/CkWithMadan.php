...
class Controller_Shengchan_Ranbu_CkWithMadan extends Controller_Shengchan_Chuku {
	var $fldMain;
	var $headSon;
	var $rules; //表单元素的验证规则
	// /构造函数
	function __construct() {
		...
		$this->headSon = array(
			...
			'ruku2proId'=>array(
				'title' => '验收记录', 
				"type" => "btPopup",
				'url'=>url('Shengchan_Ranbu_CkWithMadan','ListMadan'),
				'textFld'=>'rukuCode',
				'hiddenFld'=>'id',
				'inTable'=>true,
				'dialogWidth'=>900,
	...
	*/
	function actionRight(){
		redirect(url("Shengchan_Ranbu_Cpck",'right'));	exit;
	}
}
?>