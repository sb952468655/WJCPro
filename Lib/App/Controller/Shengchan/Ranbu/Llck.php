...
class Controller_Shengchan_Ranbu_Llck extends Controller_Shengchan_Chuku {
	// /构造函数
	function __construct() {
		...
		$this->fldMain = array(
			...
			'highLever' =>array(
				...
				"title" => '高级功能',
				'textFld'=>'导入验收记录',
				'url'=>url('Shengchan_Ranbu_Scrk','GetScrkData')
			),
		...
		$this->_rightCheck='3-2-2-4';
		$this->_addCheck='3-2-2-3';
	...
	*/
	function actionSaveTui(){
		...
		//查询之前设置的单价
		$sql="select plan2proId,planGxId from cangku_chuku_son where id='{$_POST['return4id']}'";
	...
	*/
	function actionReport(){
		$this->authCheck('3-2-2-8');
		//汇总字段
		// $this->strGroup="kuweiId,productId,pihao,color,dengji";
