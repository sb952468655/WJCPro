...
class Controller_Shengchan_Zhizao_ScrkDx extends Controller_Shengchan_Ruku {
	// /构造函数
	function __construct() {
		...
		$this->headSon = array(
			...
			'planGxId' => array(
				...
				"type" => "btPopup",
				'name' => 'planGxId[]',
				'url'=>url('Shengchan_PlanTl','popupGx',array('ColType'=>$this->_kind)),
				'textFld'=>'touliaoCode',
				'hiddenFld'=>'plangxId',
				'inTable'=>true,
				'dialogWidth'=>860
	...
	*/
	function actionTuiAdd(){
		...
		//查找调入数据
		$dbInfo = $this->_subModel->find(array('diaoboId'=>$parent['id']));
		// dump($dbInfo);exit;
		//库位信息
