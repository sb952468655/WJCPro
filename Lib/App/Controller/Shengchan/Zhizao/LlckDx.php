...
class Controller_Shengchan_Zhizao_LlckDx extends Controller_Shengchan_Chuku {
	// /构造函数
	function __construct() {
		...
		$this->fldMain = array(
			...
			'highLever' =>array(
				...
				"title" => '高级功能',
				'textFld'=>'导入验收记录',
				'url'=>url('Shengchan_Zhizao_Scrk','GetScrkData'),
				// 'dialogWidth'=>800
			),
		...
		$this->_rightCheck='3-2-1-62';
		$this->_addCheck='3-2-1-61';
