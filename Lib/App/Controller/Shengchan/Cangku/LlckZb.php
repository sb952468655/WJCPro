...
class Controller_Shengchan_Cangku_LlckZb extends Controller_Shengchan_Chuku {
	// /构造函数
	function __construct() {
		...
		$this->headSon = array(
			...
			'planTlId' => array(
				...
				'value'=>'', 
				'name' => 'planTlId[]',
				'url'=>url('Shengchan_PlanTl','popupView'),
				'textFld'=>'touliaoCode',
				'hiddenFld'=>'planTlId',
				'inTable'=>true,
				'dialogWidth'=>920
		...
		$this->_rightCheck='3-1-22';
		$this->_addCheck='3-1-21';
	}
