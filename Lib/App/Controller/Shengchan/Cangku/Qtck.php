...
class Controller_Shengchan_Cangku_Qtck extends Controller_Shengchan_Chuku {
	// /构造函数
	function __construct() {
		...
		//出库主信息
		$this->fldMain = array(
			'chukuCode' => array('title' => '出库单号', "type" => "text", 'readonly' => true, 'value' => $this->_getNewCode('SKQC','cangku_chuku','chukuCode')),
		...
		// $this->sonTpl="";
		$this->_rightCheck='3-1-16';
		$this->_addCheck='3-1-15';
	}
	...
	*/
	function actionRight(){
		...
		$sql="select x.*,b.kuweiName from cangku_chuku x 
