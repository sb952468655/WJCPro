...
class Controller_Shengchan_Hzl_Cgrk extends Controller_Shengchan_Ruku {
	// /构造函数
	function __construct() {
		...
		$this->fldMain = array(
			...
			'type' => array('title' => '布类型', 'type' => 'select', 'options' => $this->getHzlKind()),
			'kuweiId' => array(
				'title' => '仓库', 
				"type" => "Popup",
	...
	*/
	function actionListView(){
		$this->authCheck('3-2-2-16-1');
		$danjiaCheck = $this->authCheck('3-2-2-16-4',true);
		...
		$sql="select x.*,b.kuweiName,
			...
			y.pihao,y.color,y.dengji,y.cnt,y.cntJian,y.memoView,y.id as chuku2ProId,y.return4id,y.danjia,
			y.money,	
