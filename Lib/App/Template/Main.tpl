...
<body>
  ...
  <div id='header' style="width:100%;height:100%; color:white;background-image:url(Resource/Image/bg_top.gif);text-align:center;">
	<div style="float:left; margin:8px; padding-top:5px; font:16px Arial, Helvetica, sans-serif; font-weight:bold;">
		<img src="Resource/Image/logo2.gif" style="vertical-align:middle; height:27px; font-family:"微软雅黑", "新宋体";" />&nbsp;欢迎进入{webcontrol type='GetAppInf' varName='compName'}信息管理系统！
	</div>
...
<img src="Resource/Image/huiyi_icon.gif">&nbsp;{$smarty.session.REALNAME}&nbsp;&nbsp;&nbsp;&nbsp;
	  	<a href="?controller=Login&action=logout" style="color:white;text-decoration: underline;">注销</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:void(0)" onClick="closeWin()" style="color:white;text-decoration: underline;">退出</a>&nbsp;&nbsp;&nbsp;&nbsp;{$tool} </p>
	</div>
  </div>
  <div id='footer'>
  	<table>
