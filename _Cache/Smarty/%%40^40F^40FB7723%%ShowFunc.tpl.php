<?php /* Smarty version 2.6.10, created on 2015-09-12 09:34:01
         compiled from Acm/ShowFunc.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'webcontrol', 'Acm/ShowFunc.tpl', 4, false),)), $this); ?>
<?php $this->_cache_serials['Lib/App/../../_Cache/Smarty\%%40^40F^40FB7723%%ShowFunc.tpl.inc'] = '74a76b2e84edfa68db05f73d12d2f691'; ?><html xmlns="http://www.w3.org/1999/xhtml">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><?php echo $this->_tpl_vars['title']; ?>
</title>
<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:74a76b2e84edfa68db05f73d12d2f691#0}';}echo $this->_plugins['function']['webcontrol'][0][0]->_pi_func_webcontrol(array('type' => 'LoadJsCss','src' => "Resource/Script/jquery.js"), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:74a76b2e84edfa68db05f73d12d2f691#0}';}?>
...
<head>
    ...
    <script type="text/javascript">
		...
		var _cacheMap = ';  echo $this->_tpl_vars['map'];  echo ';
		...
		//o.initData = ';  echo $this->_tpl_vars['data'];  echo ';
		o.data = ';  echo $this->_tpl_vars['data'];  echo ';
		//_cacheMap =
		//debugger;
...
<body>
    <div id="role">
      <table>
            ...
            <?php $_from = $this->_tpl_vars['rowRole']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
?>
            <tr onMouseOver="if(this!=_cRow) this.style.backgroundColor='#ccc'" onMouseOut="if(this!=_cRow) this.style.backgroundColor='#efefef'" bgcolor="#efefef" id='trRole' val="<?php echo $this->_tpl_vars['item']['id']; ?>
">
              <td style="padding-left:20px;"><?php echo $this->_tpl_vars['item']['roleName']; ?>
</td>
            </tr>
