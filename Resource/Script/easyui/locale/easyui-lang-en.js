if ($.fn.pagination){
	$.fn.pagination.defaults.beforePageText = '当前页';
	$.fn.pagination.defaults.afterPageText = '总页数{pages}';
	$.fn.pagination.defaults.displayMsg = '显示第{from}条到{to}条记录,共有 {total}条记录';
}
if ($.fn.datagrid){
