    ...
    $.Autocompleter = function($elem, options) {
		...
		*/
		$elem.focus(function(e){
			//edit by li on input focus
			if(self.options.onFocus==true){
				if(this.value.length>self.options.minChars)self.deactivate(true);
				else self.activate();
			}
		});
    };
    ...
    $.Autocompleter.prototype.showResults = function(results, filter) {
        ...
        if (numResults) {
            ...
            if (this.options.autoWidth) {
                autoWidth = this.dom.$elem.outerWidth() - this.dom.$results.outerWidth() + this.dom.$results.width()+2;
