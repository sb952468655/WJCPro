<!--
/*注意
1:在调用时先调用jquery.js文件
2:<input name='dateFrom' onclick='calendar(event)'/>  不能写为
...
function writeIframe()
{
    ...
    "    <td width=15 height=19 class=bg title='向前�?1 �?#13;快捷键：�? style='cursor: hand' onclick='parent.prevM()'><b>&lt;</b></td>"+
    ...
    "        onmouseover='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'"+
    "        onmouseout='this.bgColor=parent.WebCalendar.lightColor; this.style.color=parent.WebCalendar.wordColor'></td>"+
    "    <td width=15 class=bg title='向后�?1 �?#13;快捷键：�? onclick='parent.nextM()' style='cursor: hand'><b>&gt;</b></td></tr></table>"+
    ...
    "    <tr align=center><td height=20>�?/td><td>一</td><td>�?/td><td>�?/td><td>�?/td><td>�?/td><td>�?/td></tr></table>"+
    ...
    "    <tr><td><input name=prevYear title='向前�?1 �?#13;快捷键：�? onclick='parent.prevY()' type=button value='&lt;&lt;'"+
    "    onfocus='this.blur()' style='meizz:expression(this.disabled=parent.WebCalendar.thisYear==1000)'><input"+
    "    onfocus='this.blur()' name=prevMonth title='向前�?1 �?#13;快捷键：�? onclick='parent.prevM()' type=button value='&lt;&nbsp;'>"+
    ...
    "    </td><td align=right><input title='向后�?1 �?#13;快捷键：�? name=nextMonth onclick='parent.nextM()' type=button value='&nbsp;&gt;'"+
    "    onfocus='this.blur()'><input name=nextYear title='向后�?1 �?#13;快捷键：�? onclick='parent.nextY()' type=button value='&gt;&gt;'"+
...
var TmisCalendar = function() //初始化日历的设置
{
    ...
    this.regInfo   += "&#13;&#13;Ver 2.0：walkingpoison(水晶�?&#13;Ver 1.0：meizz(梅花雪疏影横�?";
    ...
    this.iframe     = document.getElementById("meizzCalendarIframe").contentWindow; //日历�?iframe 载体
...
function writeCalendar() //对日历显示的数据的处理程�?
{
    ...
    WebCalendar.iframe.document.getElementById('meizzYearHead').innerHTML  = y +" �?;
    WebCalendar.iframe.document.getElementById('meizzYearMonth').innerHTML = parseInt(m, 10) +" �?;
